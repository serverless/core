...
Serverless Components can be created by anyone.  Serverless Inc. currently makes and maintains several [which you can find here](https://www.github.com/serverless-components).
